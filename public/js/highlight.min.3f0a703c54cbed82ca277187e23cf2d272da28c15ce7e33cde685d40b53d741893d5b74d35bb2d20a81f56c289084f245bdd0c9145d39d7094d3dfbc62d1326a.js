    ...
    h = (e, n, o, i) => {
      if ((n && typeof n == 'object') || typeof n == 'function')
        for (let a of s(n))
          !g.call(e, a) &&
            a !== o &&
            t(e, a, { get: () => n[a], enumerable: !(i = x(n, a)) || i.enumerable });
      return e;
    },
    u = (e, n, s) => (
      (s = e != null ? f(l(e)) : {}),
      h(n || !e || !e.__esModule ? t(s, 'default', { value: e, enumerable: !0 }) : s, e)
    ),
    v = p({
      'node_modules/highlight.js/lib/core.js'(e, t) {
        ...
        function k(e) {
          return (
            ...
            Object.getOwnPropertyNames(e).forEach(function (t) {
              var n = e[t];
              typeof n == 'object' && !Object.isFrozen(n) && k(n);
            }),
            e
          );
        }
        ...
        ((Z = '</span>'),
          ...
          (ce = class {
            ...
            openNode(e) {
              if (!b(e)) return;
              let t = e.kind;
              (e.sublanguage ? (t = `language-${t}`) : (t = J(t, { prefix: this.classPrefix })),
                this.span(t));
            }
            closeNode(e) {
              if (!b(e)) return;
        ...
        ((se = /\b\B/),
          ...
          (h = '[a-zA-Z_]\\w*'),
          (A = '\\b\\d+(\\.\\d+)?'),
          (j = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)'),
          (C = '\\b(0b[01]+)'),
          (F =
            '!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~'),
          (T = (e = {}) => {
          ...
          (D = { scope: 'string', begin: "'", end: "'", illegal: `\\n`, contains: [r] }),
          ...
          (l = function (e, t, s = {}) {
            const i = n({ scope: 'comment', begin: e, end: t, contains: [] }, s);
            i.contains.push({
              scope: 'doctag',
          ...
          (H = l('/\\*', '\\*/')),
          (I = l('#', '$')),
          (B = { scope: 'number', begin: A, relevance: 0 }),
          (V = { scope: 'number', begin: j, relevance: 0 }),
          ($ = { scope: 'number', begin: C, relevance: 0 }),
          (W = {
            begin: /(?=\/[^/\n]*\/)/,
            contains: [
              {
          ...
          (U = { scope: 'title', begin: E, relevance: 0 }),
          (K = { scope: 'title', begin: h, relevance: 0 }),
          (q = { begin: '\\.\\s*' + h, relevance: 0 }),
          (Y = function (e) {
        ...
        ((ne = (e) => {
          ...
          (Object.keys(e).forEach((t) => {
            ...
            (e.begin = o(n.beforeMatch, de(n.begin))),
            (e.starts = { relevance: 0, contains: [Object.assign(n, { endsParent: !0 })] }),
            (e.relevance = 0),
            delete n.beforeMatch);
        }),
          (M = ['of', 'and', 'for', 'in', 'not', 'or', 'if', 'then', 'parent', 'list', 'value']),
          (oe = 'keyword'));
        ...
        function _e(e) {
          ...
          if (e.skip || e.excludeBegin || e.returnBegin)
            throw (s('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), u);
          if (typeof e.beginScope != 'object' || e.beginScope === null)
            throw (s('beginScope must be object'), u);
          (re(e, e.begin, { key: 'beginScope' }), (e.begin = x(e.begin, { joinWith: '' })));
        }
        function pe(e) {
          if (!Array.isArray(e.end)) return;
          if (e.skip || e.excludeEnd || e.returnEnd)
            throw (s('skip, excludeEnd, returnEnd not compatible with endScope: {}'), u);
          if (typeof e.endScope != 'object' || e.endScope === null)
            throw (s('endScope must be object'), u);
          (re(e, e.end, { key: 'endScope' }), (e.end = x(e.end, { joinWith: '' })));
        }
        function ge(e) {
          e.scope &&
        ...
        function be(e) {
          ...
          class o {
            ...
            compile() {
              ...
              ((this.matcherRe = t(x(e, { joinWith: '|' }), !0)), (this.lastIndex = 0));
            }
            exec(e) {
          ...
          function s(n, o) {
            ...
            ([Ce, we, ve, ne].forEach((e) => e(n, o)),
              e.compilerExtensions.forEach((e) => e(n, o)),
              (n.__beforeBegin = null),
              [xe, Oe, fe].forEach((e) => e(n, o)),
              (n.isCompiled = !0));
            let r = null;
            return (
              typeof n.keywords == 'object' &&
                ...
                (r = n.keywords.$pattern),
                delete n.keywords.$pattern),
              (r = r || /\w+/),
              n.keywords && (n.keywords = ie(n.keywords, e.case_insensitive)),
              ...
              o &&
                ...
                n.endsWithParent &&
                  o.terminatorEnd &&
                  (i.terminatorEnd += (n.end ? '|' : '') + o.terminatorEnd)),
          ...
          return ((e.classNameAliases = n(e.classNameAliases || {})), s(e));
        }
        function ae(e) {
        ...
        ((te = '11.5.1'),
          ...
          (G = function (e) {
            ...
            function P(e) {
              ...
              const s = t.languageDetectRe.exec(o);
              if (s) {
                const t = n(s[1]);
                return (
                  t ||
                    (_(k.replace('{}', s[1])),
                    _('Falling back to no-highlight mode for this block.', e)),
                  t ? s[1] : 'no-highlight'
                );
              }
              return o.split(/\s+/).find((e) => b(e) || n(e));
            }
            function O(e, t, n) {
              let o = '',
                a = '';
              (typeof t == 'object'
                ...
                : (i('10.7.0', 'highlight(lang, code, ...args) has been deprecated.'),
                  i(
                    '10.7.0',
...
https://github.com/highlightjs/highlight.js/issues/2277`
                  ...
                  (o = t)),
                n === void 0 && (n = !0));
              const s = { code: o, language: a };
              l('before:highlight', s);
              const r = s.result ? s.result : h(s.language, s.code, n);
              return ((r.code = s.code), l('after:highlight', r), r);
            }
            function h(e, o, i, r) {
              ...
              function T() {
                ...
                for (; e; ) {
                  ...
                  const s = f.case_insensitive ? e[0].toLowerCase() : e[0],
                    o = H(l, s);
                  if (o) {
                    const [n, i] = o;
                    if (
                      ...
                      const t = f.classNameAliases[n] || n;
                      u.addKeyword(e[0], t);
                    }
                  } else t += e[0];
                  ((n = l.keywordPatternRe.lastIndex), (e = l.keywordPatternRe.exec(d)));
                }
              ...
              function P() {
                ...
                if (typeof l.subLanguage == 'string') {
                  ...
                  ((e = h(l.subLanguage, d, !0, S[l.subLanguage])), (S[l.subLanguage] = e._top));
                } else e = v(d, l.subLanguage.length ? l.subLanguage : null);
                (l.relevance > 0 && (y += e.relevance), u.addSublanguage(e._emitter, e.language));
              }
              function b() {
                (l.subLanguage != null ? P() : T(), (d = ''));
              }
              function F(e, t) {
                let n = 1;
                const s = t.length - 1;
                for (; n <= s; ) {
                  ...
                  const s = f.classNameAliases[e[n]] || e[n],
                    o = t[n];
                  (s ? u.addKeyword(o, s) : ((d = o), T(), (d = '')), n++);
                }
              }
              function E(e, t) {
                return (
                  e.scope &&
                    ...
                    u.openNode(f.classNameAliases[e.scope] || e.scope),
                  e.beginScope &&
                    (e.beginScope._wrap
                      ? (u.addKeyword(
                          d,
                          f.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap
                        ),
                        (d = ''))
                      : e.beginScope._multi && (F(e.beginScope, t), (d = ''))),
              ...
              function R(e) {
                return l.matcher.regexIndex === 0 ? ((d += e[0]), 1) : ((_ = !0), 0);
              }
              function L(e) {
                const n = e[0],
                  t = e.rule,
                ...
                for (const t of o) {
                  if (!t) continue;
                  if ((t(e, s), s.isMatchIgnored)) return R(n);
                }
                return (
                  t.skip
                    ? (d += n)
              ...
              function N(e) {
                ...
                l.endScope && l.endScope._wrap
                  ? (b(), u.addKeyword(t, l.endScope._wrap))
                  : l.endScope && l.endScope._multi
                    ? (b(), F(l.endScope, e))
                    : n.skip
                      ? (d += t)
                      : (n.returnEnd || n.excludeEnd || (d += t), b(), n.excludeEnd && (d = t));
                do
                  (l.scope && u.closeNode(),
                    !l.skip && !l.subLanguage && (y += l.relevance),
                    (l = l.parent));
                while (l !== s.parent);
                return (s.starts && E(s.starts, e), n.returnEnd ? 0 : t.length);
              }
              function z() {
                const e = [];
                for (let t = l; t !== f; t = t.parent) t.scope && e.unshift(t.scope);
                e.forEach((e) => u.openNode(e));
              }
              let j = {};
              function A(t, n) {
                const s = n && n[0];
                if (((d += t), s == null)) return (b(), 0);
                if (j.type === 'begin' && n.type === 'end' && j.index === n.index && s === '') {
                ...
                if (((j = n), n.type === 'begin')) return L(n);
                if (n.type === 'illegal' && !i) {
                  const e = new Error(
                    'Illegal lexeme "' + s + '" for mode "' + (l.scope || '<unnamed>') + '"'
                  );
                  throw ((e.mode = l), e);
                }
                if (n.type === 'end') {
              ...
              const f = n(e);
              if (!f) throw (s(k.replace('{}', e)), new Error('Unknown language: "' + e + '"'));
              const D = be(f);
              let C = '',
                l = r || D;
              const S = {},
              ...
              try {
                for (l.matcher.considerAll(); ; ) {
                  (O++, _ ? (_ = !1) : l.matcher.considerAll(), (l.matcher.lastIndex = g));
                  const e = l.matcher.exec(o);
                  if (!e) break;
                  const t = o.substring(g, e.index),
                    n = A(t, e);
                  g = e.index + n;
                }
                return (
                  ...
                  u.finalize(),
                  (C = u.toHTML()),
                  { language: e, value: C, relevance: y, illegal: !1, _emitter: u, _top: l }
                );
              } catch (t) {
            ...
            function g(e) {
              ...
              if (b(s)) return;
              if (
                (l('before:highlightElement', { el: e, language: s }),
                e.children.length > 0 &&
                ...
                const t = new ee('One of your code blocks includes unescaped HTML.', e.innerHTML);
                throw t;
              }
              i = e;
              const o = i.textContent,
                n = s ? O(o, { language: s, ignoreIllegals: !0 }) : v(o);
              ((e.innerHTML = n.value),
                B(e, s, n.language),
                ...
                l('after:highlightElement', { el: e, result: n, text: o }));
            }
            function R(e) {
              t = f(t, e);
            }
            const S = () => {
              (u(), i('10.6.0', 'initHighlighting() deprecated.  Use highlightAll() now.'));
            };
            function M() {
              (u(), i('10.6.0', 'initHighlightingOnLoad() deprecated.  Use highlightAll() now.'));
            }
            let j = !1;
            function u() {
            ...
            typeof window != 'undefined' &&
              ...
              window.addEventListener('DOMContentLoaded', F, !1);
            function T(t, n) {
              let o = null;
              try {
                o = n(e);
                ...
                if (
                  (s("Language definition for '{}' could not be registered.".replace('{}', t)), !c)
                )
                  throw e;
                (s(e), (o = A));
              }
              (o.name || (o.name = t),
                ...
                o.aliases && E(o.aliases, { languageName: t }));
            }
            function D(e) {
              delete a[e];
            ...
            for (const e in d) typeof d[e] == 'object' && z(d[e]);
  ...
  function y(e) {
    const n = e.regex,
      ...
      s = { $pattern: r, keyword: m, literal: c, built_in: j, 'variable.language': b },
      g = '[0-9](_?[0-9])*',
      h = `\\.(${g})`,
      ...
      d = { className: 'subst', begin: '\\$\\{', end: '\\}', keywords: s, contains: [] },
      w = {
        begin: 'html`',
        end: '',
      ...
      x = { className: 'string', begin: '`', end: '`', contains: [e.BACKSLASH_ESCAPE, d] },
      F = e.COMMENT(/\/\*\*(?!\/)/, '\\*/', {
        relevance: 0,
        contains: [
          {
      ...
      f = { className: 'comment', variants: [F, e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE] },
      k = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, w, O, x, y];
    d.contains = k.concat({ begin: /\{/, end: /\}/, keywords: s, contains: ['self'].concat(k) });
    const A = [].concat(f, d.contains),
      p = A.concat([{ begin: /\(/, end: /\)/, keywords: s, contains: ['self'].concat(A) }]),
      l = {
        className: 'params',
        begin: /\(/,
        end: /\)/,
      ...
      D = { relevance: 0, match: /\b[A-Z][A-Z_0-9]+\b/, className: 'variable.constant' };
    function N(e) {
    ...
    const L = {
      ...
      _ =
        ...
        ')\\s*=>',
      I = {
        match: [/const|var|let/, /\s+/, t, /\s*/, /=\s*/, /(async\s*)?/, n.lookahead(_)],
        keywords: 'async',
        className: { 1: 'keyword', 3: 'title.function' },
        contains: [l],
      };
    return {
      ...
      contains: [
        ...
        { beginKeywords: 'while if switch catch for' },
        {
          ...
          returnBegin: !0,
          label: 'func.def',
          contains: [l, e.inherit(e.TITLE_MODE, { begin: t, className: 'title.function' })],
        },
        { match: /\.\.\./, relevance: 0 },
        R,
        { match: '\\$' + t, relevance: 0 },
  ...
  function _(e) {
    const t = { className: 'attr', begin: /"(\\.|[^\\"\r\n])*"(?=\s*:)/, relevance: 1.01 },
      ...
      s = { beginKeywords: ['true', 'false', 'null'].join(' ') };
    return {
      name: 'JSON',
      contains: [
        t,
  ...
  function w(e) {
    ...
    Object.assign(t, {
      className: 'variable',
      variants: [{ begin: l.concat(/\$[\w\d#@][\w\d_]*/, `(?![\\w\\d])(?![$])`) }, a],
    });
    const n = { className: 'subst', begin: /\$\(/, end: /\)/, contains: [e.BACKSLASH_ESCAPE] },
      ...
      s = { className: 'string', begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, t, n] };
    n.contains.push(s);
    const r = { className: '', begin: /\\"/ },
      ...
      i = e.SHEBANG({ binary: `(${d.join('|')})`, relevance: 10 }),
      h = {
        className: 'function',
        begin: /\w[\w\d_]*\s*\(\s*\)\s*\{/,
        returnBegin: !0,
    ...
    return {
      ...
      contains: [i, e.SHEBANG(), h, o, e.HASH_COMMENT_MODE, u, p, s, r, c, t],
    };
  }
  function O(e) {
    const t = e.regex,
      ...
      r = e.inherit(o, { begin: /\(/, end: /\)/ }),
      c = e.inherit(e.APOS_STRING_MODE, { className: 'string' }),
      i = e.inherit(e.QUOTE_STRING_MODE, { className: 'string' }),
      a = {
        endsWithParent: !0,
        illegal: /</,
        relevance: 0,
        contains: [
          { className: 'attr', begin: l, relevance: 0 },
          {
            begin: /=\s*/,
            relevance: 0,
            contains: [
      ...
      contains: [
        {
          ...
          contains: [
            ...
            r,
            {
              ...
              contains: [{ className: 'meta', begin: /<![a-z]/, end: />/, contains: [o, r, i, c] }],
            },
          ],
        },
        ...
        s,
        {
          ...
          variants: [
            { begin: /<\?xml/, relevance: 10, contains: [i] },
            { begin: /<\?[a-z][a-z0-9]+/ },
          ],
        },
        {
        ...
        { className: 'tag', begin: /<>|<\/>/ },
        {
          ...
          contains: [{ className: 'name', begin: n, relevance: 0, starts: a }],
        },
        {
          className: 'tag',
  ...
  function n(e) {
    ...
    const o = {
      ...
      c = { begin: /\[/, end: /\]/, contains: [t, i, o, a, s, 'self'], relevance: 0 },
      l = /[A-Za-z0-9_-]+/,
      d = /"(\\"|[^"])*"/,
      u = /'[^']*'/,
      r = n.either(l, d, u),
    ...
    return {
      ...
      contains: [
        ...
        { begin: h, className: 'attr', starts: { end: /$/, contains: [t, c, i, o, a, s] } },
      ],
    };
  }
  function C(e) {
    const n = 'true false yes no null',
      ...
      r = '(\\.[0-9]*)?',
      d = '([ \\t])*(Z|[-+][0-9][0-9]?(:[0-9][0-9])?)?',
      u = { className: 'number', begin: '\\b' + l + c + r + d + '\\b' },
      o = { end: ',', endsWithParent: !0, excludeEnd: !0, keywords: n, relevance: 0 },
      m = { begin: /\{/, end: /\}/, contains: [o], illegal: `\\n`, relevance: 0 },
      f = { begin: '\\[', end: '\\]', contains: [o], illegal: `\\n`, relevance: 0 },
      i = [
        g,
    ...
    return (
      ...
      s.push(h),
      (o.contains = s),
      { name: 'YAML', case_insensitive: !0, aliases: ['yml'], contains: i }
    );
  }
  function E(e) {
    const h = e.regex,
      ...
      r = e.inherit(s, { contains: [] }),
      a = e.inherit(n, { contains: [] });
    (s.contains.push(a), n.contains.push(r));
    let t = [i, o];
    ([s, n, r, a].forEach((e) => {
    ...
    const f = {
      ...
      p = { className: 'quote', begin: '^>\\s+', contains: t, end: '$' };
    return {
      name: 'Markdown',
      aliases: ['md', 'mkdown', 'mkd'],
      contains: [f, i, u, s, n, p, c, m, o, d],
    };
  }
  function k(e) {
    const p = e.regex,
      ...
      l = { $pattern: /[A-Za-z]\w+|__\w+__/, keyword: u, built_in: g, literal: f, type: m },
      t = { className: 'meta', begin: /^(>>>|\.\.\.) / },
      o = { className: 'subst', begin: /\{/, end: /\}/, keywords: l, illegal: /#/ },
      i = { begin: /\{\{/, relevance: 0 },
      c = {
        className: 'string',
        contains: [e.BACKSLASH_ESCAPE],
        variants: [
          ...
          },
          {
            ...
            contains: [e.BACKSLASH_ESCAPE, t, i, o],
          },
          {
            begin: /([fF][rR]|[rR][fF]|[fF])"""/,
            end: /"""/,
          ...
          { begin: /([bB]|[bB][rR]|[rR][bB])"/, end: /"/ },
          { begin: /([fF][rR]|[rR][fF]|[fF])'/, end: /'/, contains: [e.BACKSLASH_ESCAPE, i, o] },
          { begin: /([fF][rR]|[rR][fF]|[fF])"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, i, o] },
          e.APOS_STRING_MODE,
          e.QUOTE_STRING_MODE,
        ],
      ...
      h = {
        ...
        variants: [
          { className: '', begin: /\(\s*\)/, skip: !0 },
          {
            ...
            excludeEnd: !0,
            keywords: l,
            contains: ['self', t, r, c, e.HASH_COMMENT_MODE],
          },
        ],
      };
    return (
      (o.contains = [c, r, t]),
      {
        ...
        contains: [
          ...
          { className: 'meta', begin: /^[\t ]*@/, end: /(?=#)|$/, contains: [r, h, c] },
        ],
      }
    );
  }
  (e.registerLanguage('javascript', y),
    ...
    document.addEventListener('DOMContentLoaded', () => {
      document.querySelectorAll('pre code:not(.language-mermaid)').forEach((t) => {
