((() => {
    ...
    l = a({
      'node_modules/lazysizes/lazysizes.js'(e, t) {
        (function (e, n) {
          ...
          ((e.lazySizes = s), typeof t == 'object' && t.exports && (t.exports = s));
          ...
          var o,
            ...
            u = function (e, t) {
              return (
                b[t] || (b[t] = new RegExp('(\\s|^)' + t + '(\\s|$)')),
                b[t].test(e[i]('class') || '') && b[t]
              );
            },
            h = function (e, t) {
              u(e, t) || e.setAttribute('class', (e[i]('class') || '').trim() + ' ' + t);
            },
            y = function (e, t) {
              var n;
              (n = u(e, t)) && e.setAttribute('class', (e[i]('class') || '').replace(n, ' '));
            },
            _ = function (e, t, n) {
            ...
            O = function (e, n) {
              ...
              !T && (s = t.picturefill || o.pf)
                ? (n && n.src && !e[i]('srcset') && e.setAttribute('srcset', n.src),
            ...
            m = (function () {
              var e,
                ...
                i = function () {
                  var n = o;
                  for (o = s.length ? c : s, e = !0, t = !1; n.length; ) n.shift()();
                  e = !1;
                },
                r = function (s, r) {
                  e && !r
                    ? s.apply(this, arguments)
                    : (o.push(s), t || ((t = !0), (n.hidden ? a : E)(i)));
                };
            ...
            M = function (e) {
              var n,
                ...
                c =
                  j && t > 49
                    ? function () {
                        (j(r, { timeout: t }), t !== o.ricTimeout && (t = o.ricTimeout));
                      }
                    : g(function () {
                        a(r);
                      }, !0);
              return function (e) {
                ...
                ((n = !0), (o = l - (s.now() - i)), o < 0 && (o = 0), e || o < 9 ? c() : a(c, o));
              };
            },
            k = function (e) {
              var t,
            ...
            A = (function () {
              var x,
                ...
                te = /^img$/i,
                G = /^iframe$/i,
                oe = 'onscroll' in t && !/(gle|ing)bot/.test(navigator.userAgent),
                Q = 0,
                j = 0,
                v = 0,
                b = -1,
                ...
                U = function (e) {
                  return (
                    P == null && (P = f(n.body, 'visibility') == 'hidden'),
                    P || f(e.parentNode, 'visibility') != 'hidden' || f(e, 'visibility') != 'hidden'
                  );
                },
                se = function (e, t) {
                  var o,
                  ...
                  for (
                    ...
                    ((i = (f(s, 'opacity') || 1) > 0),
                      i &&
                        f(s, 'overflow') != 'visible' &&
                        ((o = s.getBoundingClientRect()),
                        (i = D > o.left && z < o.right && N > o.top - 1 && T < o.bottom + 1)));
                  return i;
                },
                H = function () {
                  var e,
                    ...
                    y,
                    t = r.elements;
                  if ((A = o.loadMode) && v < 8 && (y = t.length)) {
                    for (e = 0, b++; e < y; e++) {
                      if (!t[e] || t[e]._lazyRace) continue;
                      if (!oe || (r.prematureUnveil && r.prematureUnveil(t[e]))) {
                        F(t[e]);
                        continue;
                      }
                      if (
                        ((!(u = t[e][i]('data-expand')) || !(s = u * 1)) && (s = j),
                        c ||
                          ((c =
                            !o.expand || o.expand < 1
                          ...
                          (p = o.hFac),
                          (P = null),
                          j < f && v < 1 && b > 2 && A > 2 && !n.hidden
                            ? ((j = f), (b = 0))
                            : A > 1 && b > 1 && v < 6
                              ? (j = c)
                              : (j = Q)),
                        g !== s &&
                          ((V = innerWidth + s * p), (q = innerHeight + s), (h = s * -1), (g = s)),
                        ...
                        (N = a.bottom) >= h &&
                          ...
                          (N || D || z || T) &&
                          (o.loadHidden || U(t[e])) &&
                          ((x && v < 3 && !u && (A < 3 || b < 4)) || se(t[e], s)))
                      ) {
                        if ((F(t[e]), (m = !0), v > 9)) break;
                      } else
                        !m &&
                          x &&
                          !d &&
                          ...
                          (R[0] || (!u && (N || D || z || T || t[e][i](o.sizesAttr) != 'auto'))) &&
                          (d = R[0] || t[e]);
                    }
                    d && !m && F(d);
                  }
                ...
                I = function (e) {
                  ...
                  ($(e), h(t, o.loadedClass), y(t, o.loadingClass), _(t, Y), p(t, 'lazyloaded'));
                },
                X = g(I),
                Y = function (e) {
                  X({ target: e.target });
                ...
                Z = function (e, t) {
                  ...
                  n == 0 ? e.contentWindow.location.replace(t) : n == 1 && (e.src = t);
                },
                J = function (e) {
                  var t,
                    n = e[i](o.srcsetAttr);
                ...
                ee = g(function (e, t, n, s, r) {
                  var c, l, d, u, f, g;
                  ((f = p(e, 'lazybeforeunveil', t)).defaultPrevented ||
                    (s && (n ? h(e, o.autosizesClass) : e.setAttribute('sizes', s)),
                    (l = e[i](o.srcsetAttr)),
                    (c = e[i](o.srcAttr)),
                    r && ((u = e.parentNode), (d = u && C.test(u.nodeName || ''))),
                    (g = t.firesLoad || ('src' in e && (l || c || d))),
                    (f = { target: e }),
                    h(e, o.loadingClass),
                    g && (clearTimeout(B), (B = a($, 2500)), _(e, Y, !0)),
                    d && S.call(u.getElementsByTagName('source'), J),
                    l
                      ? e.setAttribute('srcset', l)
                      : c && !d && (G.test(e.nodeName) ? Z(e, c) : (e.src = c)),
                    r && (l || d) && O(e, { src: c })),
                ...
                F = function (e) {
                  ...
                  if (
                    ...
                    return;
                  ((s = p(e, 'lazyunveilread').detail),
                    n && w.updateElem(e, !0, e.offsetWidth),
                    (e._lazyRace = !0),
                    v++,
                    ee(e, s, n, a, t));
                },
                ...
                L = function () {
                  ...
                  ((x = !0), (o.loadMode = 3), e(), c('scroll', K, !0));
                };
              return {
                _: function () {
                  ((W = s.now()),
                    (r.elements = n.getElementsByClassName(o.lazyClass)),
                    (R = n.getElementsByClassName(o.lazyClass + ' ' + o.preloadClass)),
                    c('scroll', e, !0),
                    c('resize', e, !0),
                    ...
                    /d$|^c/.test(n.readyState)
                      ? L()
                      : (c('load', L), n[d]('DOMContentLoaded', e), a(L, 2e4)),
                    r.elements.length ? (H(), m._lsFlush()) : e());
                },
                checkElems: e,
                unveil: F,
                _aLSL: K,
            ...
            w = (function () {
              var e,
                i = g(function (e, t, n, s) {
                  ...
                  if (
                    ...
                    for (o = 0, a = i.length; o < a; o++) i[o].setAttribute('sizes', s);
                  }
                ...
                t = function (e, t, n) {
                  ...
                  o &&
                    ((n = x(e, o, n)),
                    (s = p(e, 'lazybeforesizes', { width: n, dataAttr: !!t })),
                    s.defaultPrevented ||
                      ((n = s.detail.width), n && n !== e._lazysizesWidth && i(e, o, s, n)));
                },
                a = function () {
                  var n,
                    s = e.length;
              ...
              return {
                _: function () {
                  ((e = n.getElementsByClassName(o.autosizesClass)), c('resize', s));
                },
                checkElems: s,
                updateElem: t,
              };
            ...
            v = function () {
              !v.i && n.getElementsByClassName && ((v.i = !0), w._(), A._());
            };
          return (
            a(function () {
              o.init && v();
  ...
  (() => {
    var e,
      ...
      h = (e, t) =>
        function () {
          return (t || (0, e[i(e)[0]])((t = { exports: {} }).exports, t), t.exports);
        },
      u = (e, t, n, s) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of i(t))
            !m.call(e, a) &&
              a !== n &&
              o(e, a, { get: () => t[a], enumerable: !(s = p(t, a)) || s.enumerable });
        return e;
      },
      c = (e, t, n) => (
        (n = e != null ? f(r(e)) : {}),
        u(t || !e || !e.__esModule ? o(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
      l = h({
              ...
              var n = {
                  686: function (e, t, n) {
                    ...
                    ((r = function (t, n) {
                      var o,
                        s = T(t);
                      return (n.container.appendChild(s), (o = d()(s)), u('copy'), s.remove(), o);
                    }),
                      (j = function (t) {
                        var s =
                        ...
                        return (
                          typeof t == 'string'
                            ...
                            : t instanceof HTMLInputElement &&
                                !['text', 'search', 'url', 'tel', 'password'].includes(t?.type)
                              ? (n = r(t.value, s))
                              : ((n = d()(t)), u('copy')),
                          n
                        );
                    ...
                    ((v = function () {
                      ...
                      if (c) return a(c, { container: r });
                      if (t) return n === 'cut' ? h(t) : a(t, { container: r });
                    }),
                      (b = v));
                    function s(e) {
                      '@babel/helpers - typeof';
                    ...
                    function C(e) {
                      ...
                      return function () {
                        ...
                        return (
                          t
                            ? ((a = o(this).constructor), (s = Reflect.construct(i, arguments, a)))
                    ...
                    function E(e, t) {
                      return t && (s(t) === 'object' || typeof t == 'function') ? t : k(e);
                    }
                    function k(e) {
                      if (e === void 0)
                          ...
                          [
                            {
                              ...
                              value: function () {
                                ...
                                ((this.action =
                                  ...
                                  (this.container =
                                    s(t.container) === 'object' ? t.container : document.body));
                              },
                            },
                            {
                              key: 'listenClick',
                              value: function (t) {
                                var n = this;
                                this.listener = x()(t, 'click', function (e) {
                                  return n.onClick(e);
                                });
                              },
                            },
                  ...
                  879: function (e, t) {
                    ((t.node = function (e) {
                      ...
                      (t.nodeList = function (e) {
                        ...
                        return (
                          e !== void 0 &&
                          (n === '[object NodeList]' || n === '[object HTMLCollection]') &&
                          'length' in e &&
                  ...
                  279: function (e) {
                    ...
                    ((t.prototype = {
                      ...
                      off: function (e, t) {
                        if (((o = this.e || (this.e = {})), (n = o[e]), (i = []), n && t))
      ...
      d = c(l()),
      s = document.getElementsByTagName('pre');
    for (e = 0; e < s.length; ++e)
      ((n = s[e]),
        (a = n.getElementsByClassName('language-mermaid')[0]),
        a == null && n.insertAdjacentHTML('afterbegin', '<button class="btn btn-copy"></button>'));
  ...
  (() => {
    var e,
      ...
      h = 'instantAllowQueryString' in document.body.dataset,
      j = 'instantAllowExternalLinks' in document.body.dataset,
      m = 'instantWhitelist' in document.body.dataset,
    ...
    if (y) {
      ...
      if (
        (a || document.addEventListener('touchstart', f, e),
        u
    ...
    function p(o) {
      ...
      if (!n(i)) return;
      (i.addEventListener('mouseout', v, { passive: !0 }),
        (e = setTimeout(() => {
          (t(i.href), (e = void 0));
        }, d)));
    }
    ...
    function n(e) {
      if (!e || !e.href) return;
      if (m && !('instant' in e.dataset)) return;
      if (!j && e.origin != location.origin && !('instant' in e.dataset)) return;
      if (!['http:', 'https:'].includes(e.protocol)) return;
      if (e.protocol == 'http:' && location.protocol == 'https:') return;
      if (!h && e.search && !('instant' in e.dataset)) return;
  ...
  (() => {
    ...
    e !== null &&
      ...
      e.addEventListener('click', () => {
        ...
        const e = document.querySelector('iframe.giscus-frame');
        e &&
          e.contentWindow.postMessage(
            { giscus: { setConfig: { theme: localStorage.getItem('theme') } } },
            '*'
          );
      }),
